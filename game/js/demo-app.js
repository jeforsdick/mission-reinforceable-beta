(function () {
  ...
  async function init() {
    try {
      ...
      // The sample teacher config has a research endpoint for participant runs.
      // Public demo mission runs are neither transmitted nor persisted.
      ...
      renderHome();
      MR.setScreen('home');
      console.info('Mission: Reinforceable public demo loaded');
    } catch (error) {
      console.error(error);
