...
Mission: Reinforceable is a research project designed to support educators in implementing high-quality behavior supports.`;
  ...
  const mixHtml = active ? `<tr><td colspan="2" style="padding:4px 16px 18px;"><table role="presentation" width="100%" cellspacing="0" cellpadding="0" border="0" style="width:100%;background-color:#fffaf0;border-top:1px solid #d6a844;"><tr><td colspan="3" align="center" style="padding:14px 8px 9px;color:#60388c;font-family:'Courier New',Courier,monospace;font-size:13px;font-weight:bold;letter-spacing:1px;">YOUR MISSION MIX</td></tr><tr><td width="33%" align="center" style="padding:0 4px;color:#49362d;font-size:13px;"><img src="${assets.daily}" width="30" alt="" style="display:block;width:30px;height:auto;margin:0 auto 4px;border:0;"><strong>${Number(mix.daily) || 0}</strong> Daily</td><td width="34%" align="center" style="padding:0 4px;color:#49362d;font-size:13px;"><img src="${assets.mystery}" width="30" alt="" style="display:block;width:30px;height:auto;margin:0 auto 4px;border:0;"><strong>${Number(mix.mystery) || 0}</strong> Mystery</td><td width="33%" align="center" style="padding:0 4px;color:#49362d;font-size:13px;"><img src="${assets.crisis}" width="30" alt="" style="display:block;width:30px;height:auto;margin:0 auto 4px;border:0;"><strong>${Number(mix.crisis) || 0}</strong> Crisis</td></tr></table></td></tr>` : '';
...
<table role="presentation" width="100%" cellspacing="0" cellpadding="0" border="0" style="width:100%;background-color:#f4f1f7;"><tr><td align="center" style="padding:20px 10px;"><table role="presentation" width="600" cellspacing="0" cellpadding="0" border="0" style="width:100%;max-width:600px;background-color:#ffffff;border:1px solid #ded7e3;">
<tr><td align="center" style="padding:18px 18px 10px;"><table role="presentation" width="100%" cellspacing="0" cellpadding="0" border="0"><tr><td width="36" align="center"><img src="${assets.sparkle}" width="20" alt="Magical sparkle" style="display:block;width:20px;height:auto;border:0;"></td><td align="center"><img src="${assets.title}" width="440" alt="Mission: Reinforceable" style="display:block;width:100%;max-width:440px;height:auto;border:0;"></td><td width="36" align="center"><img src="${assets.sparkle}" width="20" alt="Magical sparkle" style="display:block;width:20px;height:auto;border:0;"></td></tr></table></td></tr>
...
<tr><td style="padding:24px 20px 20px;"><table role="presentation" cellspacing="0" cellpadding="0" border="0"><tr><td width="42"><img src="${assets.heart}" width="32" alt="Heart" style="display:block;width:32px;height:auto;border:0;"></td><td><h1 style="margin:0;color:#49362d;font-family:'Courier New',Courier,monospace;font-size:22px;line-height:27px;">${escapeHtml(greeting)}</h1></td></tr></table>
<table role="presentation" width="100%" cellspacing="0" cellpadding="0" border="0" bgcolor="#fff4d8" style="width:100%;margin-top:16px;background-color:#fff4d8;border:3px solid #49362d;box-shadow:inset 0 0 0 2px #d6a844;"><tr><td colspan="2" align="center" style="padding:17px 12px 7px;color:#60388c;font-family:'Courier New',Courier,monospace;font-size:14px;font-weight:bold;letter-spacing:1px;">YOUR ADVENTURE THIS WEEK</td></tr><tr><td width="50%" align="center" style="padding:12px 8px 17px;border-right:1px solid #d6a844;color:#49362d;"><strong style="font-size:28px;line-height:34px;">${missions}</strong><br><span style="font-size:14px;font-weight:bold;">Missions Completed</span></td><td width="50%" align="center" style="padding:12px 8px 17px;color:#49362d;"><strong style="font-size:28px;line-height:34px;">${days} of ${eligibleDays}</strong><br><span style="font-size:14px;font-weight:bold;">Days Practiced</span></td></tr>${mixHtml}</table>
<h2 style="margin:18px 0 7px;color:#60388c;font-family:'Courier New',Courier,monospace;font-size:18px;line-height:24px;">${escapeHtml(lead)}</h2><p style="margin:0;color:#443a36;font-size:16px;line-height:24px;">${escapeHtml(detail)}</p>
<table role="presentation" width="100%" cellspacing="0" cellpadding="0" border="0" bgcolor="#f1eafa" style="width:100%;margin-top:20px;background-color:#f1eafa;border:2px solid #76509a;"><tr><td align="center" style="padding:18px 14px 22px;"><img src="${assets.sparkle}" width="25" alt="" style="display:inline-block;width:25px;height:auto;vertical-align:middle;border:0;"> <strong style="color:#553078;font-family:'Courier New',Courier,monospace;font-size:15px;">ONE LAST QUEST FOR THE WEEK</strong><p style="margin:10px 0 17px;line-height:22px;">Take a minute to complete your weekly check-in.</p><!--[if mso]><v:roundrect xmlns:v="urn:schemas-microsoft-com:vml" xmlns:w="urn:schemas-microsoft-com:office-word" href="${escapeHtml(checked.url)}" style="height:56px;v-text-anchor:middle;width:340px;" arcsize="8%" strokecolor="#4a3025" strokeweight="6px" fillcolor="#9a3040"><w:anchorlock/><center style="color:#ffffff;font-family:Arial,sans-serif;font-size:16px;font-weight:bold;">COMPLETE WEEKLY CHECK-IN</center></v:roundrect><![endif]--><!--[if !mso]><!--><table role="presentation" cellspacing="0" cellpadding="0" border="0"><tr><td align="center" bgcolor="#9a3040" style="background-color:#9a3040;border:3px solid #d9a638;outline:3px solid #4a3025;box-shadow:0 5px 0 #4a3025;"><a href="${escapeHtml(checked.url)}" style="display:inline-block;padding:14px 20px;color:#ffffff;text-decoration:none;font-size:16px;line-height:22px;font-weight:bold;">COMPLETE WEEKLY CHECK-IN</a></td></tr></table><!--<![endif]--></td></tr></table></td></tr>
