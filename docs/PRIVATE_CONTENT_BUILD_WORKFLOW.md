...
Legacy protected configurations may contain a `weeklyTeacherReport` property. Current builds ignore that property; it is not required and does not require republishing otherwise valid content.
