...
| **5** | Say, “Yes, in one minute,” and start the timer. | Anna returns to her work and watches the timer. The delay is clear, but her excellent request passes without specific praise. | **Wizard:** “The clock knows the plan; Anna did not hear which move unlocked it.” This is workable waiting support, but it misses the exact praise opportunity. *Prevent · timer/delayed attention · omitted praise · attention.* | `D2_WOBBLY` |
| **0** | Whisper, “Sure—show me quickly,” and step away for a brief look. | Anna becomes immediately calm and eagerly narrates the sort. At the table, Maya draws a line on her sleeve and two children begin calling; Anna has learned that even during group, asking can produce instant departure. | **Wizard:** “Fast calm! Smooth landing! …and the small-group boundary just evaporated.” Honoring a request is helpful, but extended attention cannot be immediate here; leaving teaches no waiting and disrupts the routine. *Reinforce · immediate extended attention · attention too quickly · attention.* | `D2_ESCALATED` |
...
You return from the quick tour to find Maya upset about her sleeve and the group talking at once. Anna follows you and asks, “Can you stay with me?” Your attempt to make things easier has increased both Anna’s expectation and your workload.
...
| **5** | Prompt Anna to take two deep breaths, then point to the timer. | Her volume drops, but she asks “Help?” again without a clear timing response. **Wizard:** “Volume spell successful; communication quest still active.” Breathing helps regulation but does not fully prompt the replacement request needed now. *Teach · breathing/wait cue · adjacent skill · attention.* | `D4_WOBBLY` |
...
| **5** | Prompt, “Hands to yourself and take a breath.” | Anna moves her foot and breathes, but remains beside you asking when you will stay. **Wizard:** “The card box is safe; the attention question is still flashing.” This addresses calm behavior without prompting the functional request. *Teach · calm-body/breath prompt · incomplete replacement · attention.* | `D4_WOBBLY` |
...
| **0** | Stay beside Anna and help finish the parade so cleanup will be easier. | Anna happily gives you animals to place and the parade finishes. Across the room, the apron child waits and two peers begin dumping markers into the wrong tub; Anna now has sustained attention before transition. | **Wizard:** “The parade looks magnificent. The teacher traffic jam does not.” Extended help is not brief non-contingent attention and increases reliance on proximity. *Prevent · extensive proactive help · overattention/workload shift · attention.* | `D2_ESCALATED` |
...
Because you stayed to finish the parade, Anna hooks her arm around yours when the song starts and says, “You clean with me.” The apron remains stuck and marker sorting is going wrong across the room.
...
| **5** | Say, “Stand up and put it on the shelf,” in a calm voice. | Anna complies while still whining softly and then waits beside the shelf. The job finishes, but no appropriate request is made available. **Wizard:** “Task complete; communication channel still fuzzy.” Matter-of-fact direction limits attention but omits immediate replacement redirection. *Respond · neutral direction · missing replacement prompt · attention.* | `D4_WOBBLY` |
...
| **5** | Repeat once, “Animals in the tub, then rug,” and turn to cue the class. | Anna puts in one animal and watches you. The interaction stays brief, but progress is slow and no help request is prompted. **Wizard:** “Boundary clean, bridge only half-built.” This limits attention appropriately but misses the immediate replacement route. *Respond · brief first-then direction · incomplete redirect · attention.* | `D4_WOBBLY` |
...
| **0** | Save praise until the entire class is ready, then say, “Good job, everyone.” | Anna begins looking over her shoulder for you while two peers continue talking. Her individual transition and flexibility pass without immediate recognition. **Wizard:** “The praise train arrived late and stopped at every station.” Delayed group praise does not specifically reinforce Anna’s demonstrated behaviors. *Reinforce · delayed group praise · timing/specificity miss · attention.* | `D5_ESCALATED` |
...
| One More Minute | Credible delayed attention and promise-keeping versus fast calm through attention | D1 `reinforcement_01`; D2 none; D3 `teaching_01`; D4 `response_01`; D5 none | Yes—late requesting, bounded aid, and fulfilled attention can produce `STRONG` | Yes—timer-only support, proximity, breathing, fidgets, and aide help plausibly solve immediate problems | Yes—D1 immediate tour, D3 puzzle help, and D4 handholding/aide attention visibly calm Anna while making escalation efficient | Yes—group progress, promise credibility, independent task, proximity, peer/aide attention, and workload change | None | **Yes** |
