...
| Score | Teacher action | Consequence | Wizard | Feedback | Meta | Next |
|---|---|---|---|---|---|---|
| **10** | Pause for a brief check-in: “Quick check-in before I turn back to the group. I’ll give these two directions, then come back to you.” | Anna receives a few seconds of social attention before making a new bid and looks toward the two direction cards as you move away. You restart instruction with a clear return point and less monitoring demand. | “The attention supply crosses the bridge on schedule—no distress raven required!” | This provides brief social attention independent of Anna’s current performance, before any new bid, and pairs it with a credible return point. | *Prevent · non-contingent social attention before a bid/return point · none · attention* | `D5_SUPPORTED` |
...
| Score | Teacher action | Consequence | Wizard | Feedback | Meta | Next |
|---|---|---|---|---|---|---|
| **10** | Pause for a brief check-in: “Quick check-in before I restart cleanup. I’ll come back after the cleanup picture,” then address the class. | Anna receives the brief social check-in before making a new bid and looks toward the cleanup picture as you move away. Adult proximity ends predictably, peer watching decreases, and you can lead the transition. | “Ten seconds of attention arrive before the bridge needs a rescue expedition!” | The social attention is independent of Anna’s current behavior and arrives before a new bid; the return point keeps it bounded and credible. | *Prevent · non-contingent social attention before a bid/advance return · none · attention* | `D5_SUPPORTED` |
...
| Score | Teacher action | Consequence | Wizard | Feedback | Meta | Next |
|---|---|---|---|---|---|---|
| **10** | Give a five-second check-in: “Quick check-in before the cleanup song. I’ll come back when the song ends,” then turn to the group. | Anna receives brief social attention before making a new bid and looks toward the song cue as you move away. A credible return point is available, and the class regains its routine. | “A tiny attention spell arrives before the aftershock can call for one!” | This brief social attention is not earned by Anna’s current performance; it comes before a new bid and bounds proximity with a credible return. | *Prevent · non-contingent social attention before a bid/credible return · none · attention* | `D5_WOBBLY` |
