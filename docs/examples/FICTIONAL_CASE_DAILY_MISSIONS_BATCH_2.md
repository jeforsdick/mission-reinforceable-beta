...
| **5** | Quietly let Anna tell you one sentence “really fast,” then return to the moon page. | Anna delivers one delighted puppy detail and sits calm; two peers immediately raise hands to share pet news and the torn-card student calls louder. **Wizard:** “Kind attention delivered—and suddenly everyone wants the express lane.” Anna's appropriate bid genuinely works, which is valuable, but immediate sharing during instruction weakens the waiting boundary and makes repeated bids more efficient than a saved turn. *Reinforce · appropriate attention with weak timing/boundary · incomplete integration · attention.* | `D2_ESCALATED` |
| **0** | Say, “Not during the story,” and continue reading without acknowledging the request or giving Anna a return point. | Anna lowers her hand for a moment, then raises it again and asks, “After this page?” Her appropriate request has no clear payoff or waiting path, and nearby peers begin answering for you. **Wizard:** “The polite request found a locked door and no sign for when it opens.” Protecting the read-aloud is reasonable, but this makes appropriate asking ineffective instead of teaching or reinforcing a usable way to wait. *Integrate · dismissal without return path · appropriate request not reinforced · attention.* | `D2_WOBBLY` |
...
| **5** | Say, “I remember your turn,” place the talk card beside the last-page marker, and resume reading without giving Anna words to use. | Anna watches the card and backs up half a step, but asks, “Will you really listen?” before sitting. **Wizard:** “Turn protected; communication still buffering.” The visual endpoint and reassurance support recovery, but the teacher does not prompt Anna to perform a replacement response. *Prevent · visual endpoint/reassurance · omitted replacement prompt · attention.* | `D3_WOBBLY` |
...
| **5** | Place a spare glue bottle and a scrap of test paper in the center of the table for anyone who needs them, then continue circulating without addressing Anna. | Anna notices the backup and tests the glue independently, but still tracks you as you cross the room without a social check-in. **Wizard:** “Excellent tool forecast; no connection in the package.” Antecedent materials support is useful, but Anna receives no non-contingent attention. *Prevent · materials preparation · missed active ingredient · attention.* | `D2_WOBBLY` |
...
Anna notices the spare bottle and switches to it, but its cap is sealed too. She asks, “Can you open it?” while holding both bottles carefully. The torn-stem child is beginning to cry.
...
| **5** | Point to the repair tape and say, “That can be fixed; I’ll be there after I finish this tape,” without giving her words to use. | Anna holds the torn pieces together and watches the repair tape, but keeps saying, “Teacher?” without a clear request. **Wizard:** “Repair route visible; communication tool stayed boxed.” Information and task support are useful, but no replacement behavior is prompted. *Prevent · repair information/clear endpoint · omitted replacement prompt · attention.* | `D4_WOBBLY` |
...
| **0** | Move immediately to the waiting peers and begin helping the next child without acknowledging Anna's independent petal. | Anna watches you leave, pushes the next petal away, and calls, “Did you see this one?” **Wizard:** “The independent move happened; the praise window stayed closed.” The response keeps the help line moving but gives Anna no praise for the behavior the plan is trying to strengthen. *Reinforce · no acknowledgment · omitted praise · attention.* | `D5_ESCALATED` |
...
| **#4 The Story That Cannot Wait** | Whole-group read-aloud / meeting | Acknowledge appropriate bids without opening a conversation; ignore behavior, not child | Public teacher attention and peer amplification | none → Teach → Ignore → Praise → none | Immediate one-sentence sharing or accurate endpoints that help but weaken the full wait/teaching sequence | Personal-fact call-outs, card tapping, peer storytelling, group negotiation | Books, chapters, spoilers, bookmarks |
...
|---|---|---|---|---|---|
| #4 D2, all states | `teaching_01` — Prompt replacement behavior | Explicitly prompts an observable waiting or saved-turn request | Visual endpoints, information, or reassurance support success but do not prompt Anna to perform the replacement | Vague correction, peer rule recital, or lecture supplies no replacement prompt | **Pass** |
...
| #5 D3, all states | `teaching_01` — Prompt replacement behavior | Explicitly prompts a specific, bounded help request | Repair information, task models, choice, and problem-solving support help but do not prompt the replacement | General encouragement, task takeover, or fairness lecture provides no replacement prompt | **Pass** |
...
| Immediate calm is not automatic success | The quick puppy story is scored 5 because it legitimately reinforces an appropriate request but is poorly bounded; special-seat whispering, full-service gluing, and sustained watching visibly calm Anna while receiving 0s when they follow concern behavior or replace the skill. Legitimate brief help after a request receives 10s. | **Pass** |
