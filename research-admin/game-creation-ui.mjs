...
export function renderMissionBank(workspace, selection, importer = {}) {
  const eligible = Boolean(workspace?.case_id && workspace.case_code === 'CASE-998' && workspace.study_id === 'MR-998');
