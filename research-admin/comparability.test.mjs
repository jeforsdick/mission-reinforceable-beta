...
// Audit-compatible database history stays intact; this cleanup adds no destructive migration.
...
console.log('Comparability is absent from the active client while historical migration data is preserved.');
