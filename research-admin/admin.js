...
function renderCounts() {
  ...
  const cards = [['New Intakes', count('submitted')], ['Approved / Preparing', count('approved')], ['Prepared Cases', caseCounts.prepared], ['Intervention Active', caseCounts.intervention]];
