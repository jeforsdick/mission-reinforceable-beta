...
import { attentionForCase, baselineReadiness, measureNeeds, studyWideAttention, COACHING_FOCUSES, partitionDashboardCases, dashboardCaseCounts } from './operations-model.mjs';
...
const state = { client: null, intakes: [], operations: { cases: [], study_wide_tasks: [] }, showArchivedCases: false, selected: null, accounts: {}, communications: { teacher_reminder_system_enabled: false, game_login_email_enabled: false }, qaLink: '', authoringWorkspace: null, missionSelection: null, missionDraft: null, missionNav: { decision: 1, branch: 'supported' }, missionMessage: '', setupDraft: null, resourceDraft: null, setupMessage: '', resourceMessage: '', resourceOpenSections: [], fullDraftCheck: null, validatedRevisionManifest: null, publishResult: null, publishedSource: null };
...
function renderStudyOverview() {
  ...
  const visibleCases=state.showArchivedCases?[...current,...archived]:current;
