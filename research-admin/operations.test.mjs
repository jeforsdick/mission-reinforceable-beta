...
import { CHECKLIST, MEASURES, PHASES, COACHING_FOCUSES, LIFECYCLE_STAGES, baselineReadiness, measureNeeds, interventionReadiness, attentionForCase, studyWideAttention, timelineForCase, checklistStatuses, denverToday, lifecycleStage, nextAction, observationSummary } from './operations-model.mjs';
...
const interventionMarkup=renderOperations({...baselineCase,current_phase:'intervention'}, {reminders:{enabled:false}}, x=>String(x));
