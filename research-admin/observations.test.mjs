...
assert.match(summary,/Study IOA/);assert.match(summary,/MR-001: 1 \/ 5, 20\.0%/);assert.match(summary,/Baseline: 2 \/ 10/);assert.match(summary,/Teacher: 1 · Student: 2 · Not calculable: 1/);
